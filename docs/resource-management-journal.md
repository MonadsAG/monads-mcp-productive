...
| 4 | „unterschiedlicher `booking_type`/Zielobjekt" (18812919) | Unterscheidung über gesetzte Relationship (`event` vs. `service`) | Ein Feld `booking_type` existiert in der API nicht |
