...
nichts geändert, antwortet Productive mit `304`. Die Guides werden trotzdem
geholt — sie ändern sich unabhängig von der Spec.
...
| `guides/*.md`              | Productives eigene API-Guides als Markdown gespiegelt                       |
