...
| ----------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `time_entries`          | `/api/v2/time_entries`                             | Zeit in Minuten (`time: 480` = 8h). Filter: `after`, `before`, `person_id`, `service_id`, `task_id`, `project_id`, `approver_id`, `status` (live-bestätigt: 1=approved/2=unapproved; 3-6 unbestätigt, siehe root `CLAUDE.md`) |
